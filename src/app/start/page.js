...
export default function Start() {
  return (
    <>
      <AltNav />
      <div className="py-16">
        <h1 className="text-2xl md:text-5xl leading-[2rem] tracking-[-0.1rem] md:leading-[4rem] md:tracking-[-0.2rem] font-semibold text-center">
          Hi, I&#39;m Betsy! <br /> What can I help you with?
        </h1>
        <StartBtns />
        {/* //////////// Stats //////////// */}
        <div className="flex max-w-[550px] px-10 md:px-0 mx-auto mt-20 gap-8">
