...
export default function About() {
  return (
    <>
      <AbtMain />
      {/* //////////// How section //////////// */}
      <div className="bg-[#017848] text-background px-[5rem] lg:px-[15rem] py-[5rem]">
        <h2 className="text-3xl lg:text-5xl mx-auto font-semibold leading-[2.5rem] -tracking-[0.1rem] lg:leading-[3.8rem] lg:-tracking-[0.2rem] mb-8">
