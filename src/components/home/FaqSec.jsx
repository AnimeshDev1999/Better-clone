...
export default function FaqSec() {
  return (
    <div className="py-[5rem] px-[1.5rem] lg:p-[5rem]">
      <div className="flex flex-col lg:flex-row justify-between items-baseline mb-[3.7rem]">
        <h2 className="text-5xl leading-[3.5rem] -tracking-[0.2rem] font-semibold mb-[3rem] lg:mb-0">
